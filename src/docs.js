...
const circle_left = {
  ...
  example: {code: 'circle_left(100)',
    comment: 'Draws a circle of radius 100 to the left of the turtle\'s position.'},
  category: 'turtle'
}
...
const circle_right = {
  ...
  example: {code: 'circle_right(85)',
    comment: 'Draws a circle of radius 85 to the right of the turtle\'s position.'},
  category: 'turtle'
}
...
const arc_left = {
  ...
  example: {comment: `Draws one half of a circle with a radius of 100 to the left of the turtle's position.`,
...
const arc_right = {
  ...
  The optional second argument determines the number of degrees the arc describes. The default is 90---a quarter circle.`,
  example: {comment: `Draws one quarter of a circle with a radius of 50 to the right of the turtle's position.`,
    code: `arc_right(50)`},
  category: 'turtle'
}
...
const home = {
  ...
  example: {code: 'forward(50); right(90); forward(50); home()',
...
const pen_up = {
  ...
  example: {code: 'pen_up(); forward(50)',
...
const pen_down = {
  ...
  example: {code: 'pen_up(); forward(50); pen_down(); forward(50)',
...
const show = {
  name: 'show',
  arguments: [],
  description: 'Shows the turtle. The turtle will be visible until hide is called. Has no effect if the turtle is already visible.',
...
const set_position = {
  ...
  example: {code: 'set_position({x: 200, y: 100})',
...
const color = {
  ...
  example: {code: 'color(red); forward(100)',
...
const heading = {
  ...
  example: {code: 'home(); heading()', comment: 'Gets the heading of the turtle--in this case, 0.'},
  category: 'information'
}
...
const position = {
  ...
  example: {code: 'set_position({x: 100, y: 100}); position()',
...
const display = doc => {
  ...
  if (doc.shortcut) console.log(`%cShortcut: %c${doc.shortcut}`,
    'color: gray; size: large', 
    'color: black; font-weight: bold; size: large')
